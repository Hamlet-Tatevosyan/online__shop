        ...
        <div class="row">
            <div class="breadcrumbs">
                <ol class="breadcrumb bg-dark">
                    ...
                    <li class="list-group-item bg-dark"><a class="btn btn-outline-info active" href="#">Delete Order</a></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body">
                        <h5 class="card-title text-center">Are you sure you want to delete this Order? <?php echo $id; ?></h5>
